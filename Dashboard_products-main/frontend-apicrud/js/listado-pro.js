...
let getTableData = async () => {
    ...
    try {
        ...
        if (respuesta.status === 204) {
            ...
            //Agregar los gatos de la tabla a localStorage
...
//Función para eliminar algún dato de la tabla
let deleteDataTable = ( pos ) => {
 ...
 //Función para quitar productos de la tabla
let clearDataTable = () => {
...
//Función para buscar un product de la tabla
